...
const notificationController = {
  getLatestBoughtProduct: async (req, res) => {
    try {
      ...
      const monthlyReportDay = currentDate.getDate(); // Example: Set the 15th day of each month for the report
      if (currentDate.getDate() === monthlyReportDay) {
        return successResponse(
          res,
          latestInventoryArray,
          "Your report of last month is ready."
        );
      }
